...
import { COACH_NEGATIVE_THRESHOLD, COACH_TIMEOUT_MS, EVALUATOR_WINDOW_MS } from '@openspace/shared';
import type { Agent, AgentFeedback, AgentObservation } from '@openspace/shared';
...
function buildCoachPrompt(
  ...
  const hotLines = hotTags
    ...
    .join('\n');
  return [
    'You are the Coach for an AI engineering agent in OpenSpace. Your job is to propose a small,',
