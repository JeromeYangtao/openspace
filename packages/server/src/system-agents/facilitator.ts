...
import { FACILITATOR_TIMEOUT_MS } from '@openspace/shared';
import type { Agent, Project } from '@openspace/shared';
...
function buildFacilitatorPrompt(input: FacilitatorInput): string {
  ...
  return [
    'You are the Facilitator for an AI engineering team in OpenSpace. Your job is to host a',
    ...
    '}',
    '',
    'YAML must follow OpenSpace schema: top-level keys version (string "1"), name, description?,',
